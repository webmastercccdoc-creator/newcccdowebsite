...
import sdg11Gif from '../../../../assets/images/sdg gif/11_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg11Hover from '../../../../assets/images/sdg11.png';
...
export default function Sdg11({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgElevenArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(11);
                });

                setArticles(sdgElevenArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg11-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg11Gif}
                                alt="SDG 11 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg11-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 11 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="hidden">
                                ...
                                systems, enhance inclusive and sustainable urbanization, protect the world's
                                cultural and natural heritage, and reduce the adverse per-capita
                                environmental impact of cities through improved air quality and waste
                                management. Explore the initiatives, programs, and stories from City College
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 11 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on sustainable cities and communities initiatives.</p>
                                </div>
                            )}
                        </div>
