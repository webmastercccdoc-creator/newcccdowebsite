...
<head>
    ...
    <title>Article submitted for approval</title>
</head>
<body style="font-family: Arial, Helvetica, sans-serif; background-color: #f6f8f7; color: #1f2937; line-height: 1.6; margin: 0; padding: 0;">
    <div style="max-width: 640px; margin: 0 auto; background: #ffffff; padding: 30px; border-radius: 8px;">
        ...
        <h2 style="color: #0f5132; margin: 0 0 16px; font-size: 24px;">Article Submitted for Review</h2>
        ...
        <p style="margin: 0 0 16px; font-size: 16px;">
            Your article <strong>{{ $article->title }}</strong> has been submitted successfully and is now waiting for approval.
        </p>

        <p style="margin: 0 0 16px; font-size: 16px;">
            Once an approver reviews the article, you will receive the final publication outcome by email.
        </p>
