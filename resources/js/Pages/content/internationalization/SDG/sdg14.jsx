...
import sdg14Gif from '../../../../assets/images/sdg gif/14_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg14Hover from '../../../../assets/images/sdg_14.jpg';
...
export default function Sdg14({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgFourteenArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(14);
                });

                setArticles(sdgFourteenArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg14-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg14Gif}
                                alt="SDG 14 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg14-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 14 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="hidden">
                                ...
                                coastal ecosystems, minimize and address the impacts of ocean acidification,
                                and effectively regulate harvesting while ending overfishing, illegal,
                                unreported, and unregulated fishing, and destructive fishing practices. It
                                also seeks to conserve at least 10 percent of coastal and marine areas and
                                prohibit certain forms of fisheries subsidies. Explore the initiatives,
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 14 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on life below water initiatives.</p>
                                </div>
                            )}
                        </div>
