...
import sdg12Gif from '../../../../assets/images/sdg gif/12_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg12Hover from '../../../../assets/images/sdg12.jpg';
...
export default function Sdg12({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgTwelveArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(12);
                });

                setArticles(sdgTwelveArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg12-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg12Gif}
                                alt="SDG 12 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg12-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 12 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="mt-5 mx-auto max-w-3xl text-base md:text-lg leading-relaxed text-gray-600">
                                ...
                                resources, and halve per-capita global food waste at the retail and consumer
                                levels. It also seeks to achieve the environmentally sound management of
                                chemicals and all wastes throughout their life cycle, encourage companies to
                                adopt sustainable practices and integrate sustainability information into
                                their reporting cycle, and promote public procurement practices that are
                                sustainable. Explore the initiatives, programs, and stories from City College
                                of Cagayan de Oro contributing to this global goal.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 12 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on responsible consumption and production initiatives.</p>
                                </div>
                            )}
                        </div>
