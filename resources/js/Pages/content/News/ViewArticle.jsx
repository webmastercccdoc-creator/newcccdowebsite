...
export default function ViewArticle({ article: initialArticle = null, articleImages: initialImages = [] }) {
    ...
    // Social media follow links - Updated to match navbar
    const socialLinks = {
        facebook: 'https://www.facebook.com/cccdofficial',
        twitter: 'https://twitter.com/cccdofficial',
        linkedin: 'https://www.linkedin.com/company/cccdofficial',
        youtube: 'https://www.youtube.com/cccdofficial',
