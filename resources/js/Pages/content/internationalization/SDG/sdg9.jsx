...
import sdg9Gif from '../../../../assets/images/sdg gif/9_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg9Hover from '../../../../assets/images/sdg9.png';
...
export default function Sdg9({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgNineArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(9);
                });

                setArticles(sdgNineArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg9-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg9Gif}
                                alt="SDG 9 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg9-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 9 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="mt-5 mx-auto max-w-3xl text-base md:text-lg leading-relaxed text-gray-600">
                                ...
                                sustainable industrialization, and increase the access of small-scale
                                industrial and other enterprises to financial services and markets. It also
                                seeks to upgrade infrastructure and retrofit industries to make them
                                sustainable, enhance scientific research, and upgrade the technological
                                capabilities of industrial sectors. Explore the initiatives, programs, and
                                stories from City College of Cagayan de Oro contributing to this global goal.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 9 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on industry, innovation, and infrastructure initiatives.</p>
                                </div>
                            )}
                        </div>
