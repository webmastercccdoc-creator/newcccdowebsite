...
import sdg17Gif from '../../../../assets/images/sdg gif/17_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg17Hover from '../../../../assets/images/sdg_17.jpg';
...
export default function Sdg17({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgSeventeenArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(17);
                });

                setArticles(sdgSeventeenArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg17-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg17Gif}
                                alt="SDG 17 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg17-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 17 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="hidden">
                                ...
                                commitments, and enhance international support for effective and targeted
                                capacity-building in developing countries. It also seeks to promote a
                                universal, rules-based, open, non-discriminatory, and equitable multilateral
                                trading system, increase the exports of developing countries, and enhance
                                ...
                                technology, and financial resources. Explore the initiatives, programs, and
                                stories from City College of Cagayan de Oro contributing to this global
                                goal.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 17 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on partnerships for the goals initiatives.</p>
                                </div>
                            )}
                        </div>
