...
import sdg16Gif from '../../../../assets/images/sdg gif/16_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg16Hover from '../../../../assets/images/sdg16.png';
...
export default function Sdg16({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgSixteenArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(16);
                });

                setArticles(sdgSixteenArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg16-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg16Gif}
                                alt="SDG 16 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg16-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 16 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="mt-5 mx-auto max-w-3xl text-base md:text-lg leading-relaxed text-gray-600">
                                ...
                                all forms of violence, end abuse, exploitation, trafficking, and all forms
                                of violence against and torture of children, and promote the rule of law at
                                the national and international levels. It also seeks to substantially
                                reduce corruption and bribery in all their forms, develop effective,
                                accountable, and transparent institutions, and ensure responsive,
                                inclusive, participatory, and representative decision-making at all levels.
                                Explore the initiatives, programs, and stories from City College of Cagayan
                                de Oro contributing to this global goal.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 16 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on peace, justice, and strong institutions initiatives.</p>
                                </div>
                            )}
                        </div>
