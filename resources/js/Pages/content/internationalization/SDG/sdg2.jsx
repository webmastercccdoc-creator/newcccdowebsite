...
import sdg2Gif from '../../../../assets/images/sdg gif/sdg2.gif';
import sdg2Hover from '../../../../assets/images/sdg_02.jpg';
...
export default function Sdg2({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgTwoArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(2);
                });

                setArticles(sdgTwoArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg2-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg2Gif}
                                alt="SDG 2 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg2-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 2 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="mt-5 mx-auto max-w-3xl text-base md:text-lg leading-relaxed text-gray-600">
                                ...
                                double agricultural productivity and incomes of small-scale food producers, promote
                                sustainable food production systems, and maintain the genetic diversity of seeds,
                                plants, and animals. Explore the initiatives, programs, and stories from City College
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 2 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on hunger and food security initiatives.</p>
                                </div>
                            )}
                        </div>
