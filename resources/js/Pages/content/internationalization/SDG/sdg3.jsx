...
import sdg3Gif from '../../../../assets/images/sdg gif/3_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg3Hover from '../../../../assets/images/sdg_03.jpg';
...
export default function Sdg3({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgThreeArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(3);
                });

                setArticles(sdgThreeArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg3-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg3Gif}
                                alt="SDG 3 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg3-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 3 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="mt-5 mx-auto max-w-3xl text-base md:text-lg leading-relaxed text-gray-600">
                                ...
                                other communicable diseases. It also seeks to strengthen the prevention and
                                treatment of substance abuse, reduce road injuries, and ensure universal access
                                to sexual and reproductive health-care services. Explore the initiatives,
                                programs, and stories from City College of Cagayan de Oro contributing to this
                                global goal.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 3 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on health and well-being initiatives.</p>
                                </div>
                            )}
                        </div>
