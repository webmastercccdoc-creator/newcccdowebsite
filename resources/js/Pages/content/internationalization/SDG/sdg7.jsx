...
import sdg7Gif from '../../../../assets/images/sdg gif/7_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg7Hover from '../../../../assets/images/sdg_07.jpg';
...
export default function Sdg7({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgSevenArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(7);
                });

                setArticles(sdgSevenArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg7-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg7Gif}
                                alt="SDG 7 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg7-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 7 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="hidden">
                                ...
                                in the global energy mix, and double the rate of improvement in energy
                                efficiency. It also seeks to enhance international cooperation to facilitate
                                access to clean energy research and technology, and expand infrastructure and
                                upgrade technology for supplying modern and sustainable energy services.
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 7 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on affordable and clean energy initiatives.</p>
                                </div>
                            )}
                        </div>
