...
import sdg4Gif from '../../../../assets/images/sdg gif/4_SDG_MakeEveryDayCount_Gifs_GDU.gif';
import sdg4Hover from '../../../../assets/images/sdg_04.jpg';
...
export default function Sdg4({ onBack }) {
    ...
    useEffect(() => {
        fetch("/api/news")
            ...
            .then((data) => {
                ...
                const sdgFourArticles = normalized.filter((item) => {
                    const sdgNumbers = parseSdgNumbers(item.sdg_numbers);
                    return sdgNumbers.includes(4);
                });

                setArticles(sdgFourArticles);
                setCurrentPage(1);
                setIsLoading(false);
            })
            .catch(() => {
    ...
    const paginate = (pageNumber) => {
        ...
        window.scrollTo({
            top: document.querySelector(".sdg4-section")?.offsetTop - 80 || 0,
            behavior: "smooth",
        });
    };
                ...
                <div className="news-container">
                    ...
                    <div className="mt-2 grid grid-cols-1 md:grid-cols-[1fr_minmax(180px,260px)] gap-6 md:gap-8 items-start">
                        ...
                        <div className="w-full">
                            <img
                                src={sdg4Gif}
                                alt="SDG 4 – Make Every Day Count"
                                className="w-full md:max-w-[260px] h-auto rounded-lg shadow-sm"
                            />
                        </div>
                    </div>

                    <div className="sdg4-section mt-10">
                        {/* ✅ Centered Title + Description with SDG 4 brand color */}
                        <div className="mb-8 text-center">
                            ...
                            <p className="mt-5 mx-auto max-w-3xl text-base md:text-lg leading-relaxed text-gray-600">
                                ...
                                quality early childhood development, care, and pre-primary education. It also
                                seeks to ensure equal access to affordable and quality technical, vocational,
                                and tertiary education, eliminate gender disparities in education, and
                                substantially increase the supply of qualified teachers. Explore the
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
                            {isLoading ? (
                                ...
                                <div className="col-span-1 sm:col-span-2 xl:col-span-4 py-12 text-center">
                                    ...
                                    <p className="text-lg font-medium text-gray-700">No SDG 4 articles found.</p>
                                    <p className="mt-1 text-sm text-gray-500">Check back soon for updates on quality education initiatives.</p>
                                </div>
                            )}
                        </div>
